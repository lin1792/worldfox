...
export const useSearchStore = defineStore({
  ...
  actions: {
    useupdata() {
      ...
      localStorage.getItem('quikNavigate') ? this.quikNavigate = JSON.parse(localStorage.getItem('quikNavigate')!).quikNavigate : this.quikNavigate=[{url:'https://juejin.cn',img:'https://juejin.cn',title:'稀土掘金'},{url:'https://www.zhihu.com',img:'https://www.zhihu.com',title:'知乎'},{url:'https://www.bilibili.com',img:'https://www.bilibili.com',title:'哔哩哔哩'}]
